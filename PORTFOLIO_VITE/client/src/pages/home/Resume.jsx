      ...
      <div id="resume" className="py-2">
        ...
        <div className="w-3/4 mx-auto sm:w-full flex sm:flex-col justify-center items-center">
          ...
          <p className="flex text-red-500">
            ...
            <a href="https://drive.google.com/file/d/1Apa6eXqJjUpDTcF2TssQt3b4BZq9V9Vm/view?usp=sharing" target="_blank"><FolderArrowDownIcon className="size-6 text-blue-500 cursor-pointer" /></a>
          </p>
        </div>
      </div>
    </>
