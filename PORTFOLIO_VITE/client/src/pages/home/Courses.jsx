  ...
  return (
    <div>
      ...
      <div className="flex py-10 gap-20 sm:flex-col ">
        <div className="flex flex-col gap-10 border-l-4 sm:border-none border-[#7a898a1b] w-1/4 sm:flex-row sm:overflow-x-scroll sm:w-full py-5">
        ...
        <div className="flex items-center justify-center gap-10 w-3/4 sm:flex-col sm:w-full">
